...
def create_prompt(b1: str, b2: str, b3: str, b4: str, t1: str, t2: str, t3: str, t4: str):
    return "\n".join([
        ...
        "",
        f"Q: Find an analogical mapping between the entities “{b1}”, “{b2}”, “{b3}” and “{b4}” and the entities “{t1}”, “{t2}”, “{t3}” and “{t4}”.",
        "A:"
    ])

def create_prompt_arrows(b1: str, b2: str, b3: str, b4: str, t1: str, t2: str, t3: str, t4: str):
    return "\n".join([
        "Q: Find an analogical mapping between the entities “eraser”, “paper” and “pencil” and the entities “keyboard”, “delete” and “screen”.",
...
def gpt_predict(b1: str, b2: str, b3: str, b4: str, t1: str, t2: str, t3: str, t4: str, arrows: bool):
    prompt = create_prompt_arrows if arrows else create_prompt
    response = openai.Completion.create(
        model="text-davinci-002",
        prompt=prompt(b1, b2, b3, b4, t1, t2, t3, t4),
        temperature=0.7,
        max_tokens=64,
        top_p=0.1,
        frequency_penalty=0,
...
def run(arrows: bool = False):
    ...
    for i in inputs:
        ...
        res = gpt_predict(base[0], base[1], base[2], base[3], target[0], target[1], target[2], target[3], arrows=arrows)
        print(res)
        try:
            if arrows:
                ...
                base_res_1, base_res_2, base_res_3, base_res_4 = base_res.split(":")
                target_res_1, target_res_2, target_res_3, target_res_4 = target_res.split(":")
