...
def main(relation: str, quasimodo: Quasimodo):
    ...
    qusimodo_subjects_similarity = quasimodo.get_similarity_between_subjects(pair11, pair12, n_largest=10, plural_and_singular=True)
    ...
    qusimodo_subjects_similarity = quasimodo.get_similarity_between_subjects(pair21, pair22, n_largest=10, plural_and_singular=True)
    quasimodo_common_props = [f"{val[0]} {val[1]}" for val in qusimodo_subjects_similarity]
    ...
    connection_11_21 = quasimodo.get_subject_object_props(pair11, pair21, n_largest=10, plural_and_singular=True)
    connection_12_22 = quasimodo.get_subject_object_props(pair12, pair22, n_largest=10, plural_and_singular=True)
    ...
    connection_21_11 = quasimodo.get_subject_object_props(pair21, pair11, n_largest=10, plural_and_singular=True)
    connection_22_12 = quasimodo.get_subject_object_props(pair22, pair12, n_largest=10, plural_and_singular=True)
